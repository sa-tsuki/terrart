  ...
  return (
    <Link key={article.id} href={`/${article.id}`}>
      <div className="w-card cursor-pointer group ">
        <div className="mb-1 border-solid border-gray-200 border transition duration-200 rounded-lg overflow-hidden md:group-hover:scale-105 group-hover:scale-100">
          <img
            src={
